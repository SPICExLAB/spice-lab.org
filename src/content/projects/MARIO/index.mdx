...
conferencePage:
citation: 'Li, Y., Yeon, T., Gao, C., Xu, V., Liu, X., & Ahuja, K. (2026). MARIO: Motion-Augmented Real-Time Multi-Sensor Inertial Odometry. In Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition (CVPR) (pp. 3460-3469).'
bibtex: |
